...
public class ToDoContactsAdapter extends BaseAdapter {
    ...
    public ToDoContactsAdapter(final Context pContext, ArrayList<Contact> pContactsList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewName = (TextView) itemView.findViewById(R.id.contactTextView);
