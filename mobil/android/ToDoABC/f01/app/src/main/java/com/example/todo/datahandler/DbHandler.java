...
public class DbHandler {
    ...
    public long insertToDo(ToDo todo) {
        ...
        values.put(DbContract.ToDo.CN_GPS_LONG, todo.getLongitude());
        values.put(DbContract.ToDo.CN_GPS_LAT, todo.getLatitude());
    ...
    public ToDo getToDo(long id){
        String[] columns = new String[]{
                ...
                DbContract.ToDo.CN_GPS_LAT,
                DbContract.ToDo.CN_GPS_LONG
        };
    ...
    private ToDo toDoFromCursor(Cursor cursor){
        ...
        td.setLongitude(cursor.getString(cursor.getColumnIndex(DbContract.ToDo.CN_GPS_LONG)));
        td.setLatitude(cursor.getString(cursor.getColumnIndex(DbContract.ToDo.CN_GPS_LAT)));
