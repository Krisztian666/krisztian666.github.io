...
public void importFromHttp(View view){
    ...
    if ("".equals(url.trim())){
        Toast toast = Toast.makeText(view.getContext(), 
                view.getContext().getText(R.string.fillin), Toast.LENGTH_SHORT);
        toast.show();
    } else {
        ...
        new ImportToDoTask(getApplicationContext()).execute(params);//{img:"scr-import2.png", speak:"Import"}
    }
}
}//{img:"scr-main2.png", speak:"Main"}
