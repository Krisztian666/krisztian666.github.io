...
public class ConfigureActivity extends Activity {
    ...
    / / Time format (12 / 24 h)
    public static final String PREF_H24 = "h24";//{speak:"Preference key"}
    public static final String PREF_FILE = 
                    "com.example.todo.PREFERENCE_FILE_KEY";
    ...
    public void configureSaved(View view){//{speak:"Save settings"}
        Log.i(TAG, "Add button pressed..");

        / / Set the time format of TimePicker in 
        / /        AddNewActivity/ToDoPagerAdapter
        CheckBox h24 = (CheckBox)findViewById(R.id.h24checkBox);

        SharedPreferences sharedPref = 
                getSharedPreferences(PREF_FILE, Context.MODE_PRIVATE);//{speak:"Access preferences"}
        SharedPreferences.Editor editor = sharedPref.edit();
        editor.putBoolean(PREF_H24, h24.isChecked());
        editor.commit();//{speak:"Write to Shared Preferences"}
