...
public class ToDoServiceBound extends Service {
    ...
    public void onCreate() {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(getApplicationContext());//{img:"scr-addnew-foreg1.png", speak:"Build Notification"}
        ...
        final int notificationId = 123456; //{img:"scr-addnew-foreg2.png", speak:"NotificationId must not be 0."}
