...
public class ToDoPagerAdapter extends PagerAdapter {
    ...
    @Override
    public void destroyItem(ViewGroup viewPager, 
            int position, Object currentView) {
